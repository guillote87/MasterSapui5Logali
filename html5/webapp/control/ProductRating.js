sap.ui.define([
    ...
    /**
     * @param {type of sap.ui.core.Control} Control
     * @param {type of sap.m.RatingIndicator} RatingIndicator
     * @param {type of sap.m.Label} Label
     * @param {type of sap.m.Button} Button
     * @param {type of sap.m.MessageToast}MessageToast
     */
], function (Control, RatingIndicator, Label, Button) {
    'use strict';

    return Control.extend("gq4dev.html5.control.ProductRating", {
        metadata: {
            properties: {
        ...
        _onRate: function (oEvent) {
            ...
            //actualiza el value que viene del ratingIndicator
